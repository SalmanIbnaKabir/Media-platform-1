    ...
    return (
        <div>
            <section className="py-6 ">
                <div className="container grid gap-6 mx-auto text-gray-50 text-center lg:grid-cols-2 xl:grid-cols-5">
                    <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 bg-gray-900">
                        <span className="block mb-2 text-primary">Own Media design system</span>
                        <TypeAnimation
                            sequence={[
                                'Own Media Platform',
                                3000, // Waits 3s
                        ...
                        <Link to='/postForm'>
                            <button type="button" className="w-full py-2 font-semibold rounded bg-primary text-gray-900">Create Post </button>
                        </Link>
                    </div>
